...
# run last cycle
os.system('cp ../../include/or1k_constraints.h.sfONLY  ../../include/or1k_constraints.h')
...
os.system('coppelia-klee -coi-prune=false -fast-validation=true --search=hardware -halt-when-fired=true -emit-all-errors -max-memory=100000000 --libc=uclibc --posix-runtime obj_dir/Vor1200_cpu.bc')


os.system('cp ../../include/or1k_constraints.h.basic  ../../include/or1k_constraints.h')
count = 1
...
while 1:
    ...
    os.system('make -j -C obj_dir/ -f Vor1200_cpu.mk Vor1200_cpu')
    os.system('extract-bc -l llvm-link obj_dir/Vor1200_cpu')
    os.system('coppelia-klee -fast-validation=true --search=hardware -halt-when-fired=true -emit-all-errors -max-memory=100000000 --libc=uclibc --posix-runtime obj_dir/Vor1200_cpu.bc')

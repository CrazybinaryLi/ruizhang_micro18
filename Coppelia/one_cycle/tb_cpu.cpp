// Include model header, generated from Verilating process
...
//  unsigned int du_dmr1, du_hwbkpt, du_hwbkpt_ls_r, du_flush_pipe;
  ...
  // SPR interface
  unsigned int spr_dat_pic, spr_dat_tt, spr_dat_pm, spr_dat_dmmu, spr_dat_immu, spr_dat_du, mtspr_dc_done, 
  
  // Interrupt execeptions
  unsigned int sig_int, sig_tick;
